...
<div class="row">
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="form-group">
                            ...
                            <p style="font-size: 16px; text-transform: uppercase; color: red;"><?php echo "Luis Carlos Rosales Godo" ?></p>
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="card">
    ...
    <div class="col-md-6">
        <a href="#" class="btn btn-primary" id="btn_generar"><i class="fas fa-save"></i> Enviar Pedido</a>
    </div>
